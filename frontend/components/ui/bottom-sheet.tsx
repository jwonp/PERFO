...
const BottomSheet = ({
  ...
  return (
    <>
      ...
      <div className={cn("fixed right-0 bottom-0 left-0 z-50 max-h-[90vh] overflow-y-auto rounded-t-[28px] border border-border/60 bg-[var(--surface-raised)] shadow-2xl", className)}>
